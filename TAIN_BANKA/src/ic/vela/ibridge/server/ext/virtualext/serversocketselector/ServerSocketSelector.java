	...
	/*------------------------------------------------------------------*/
	{
		...
		if (flag) {
			try {
				 ...
				 * Properties 파일명을 얻는다.
				 */
				String strParamFile = IBridgeParameter.getParam("ext.cfg.prop");
		...
		if (flag) {
			...
			if (key.isAcceptable()) {
				...
				if (!flag) {
					/////////////////////////////////////////////////////////////////
					/*
					 * TODO DATE.2013.06.30 : 나중에 활용할 것..
					 */
					if (flag) Logger.log("SERVER : SUCCESS ACCEPTED. [%s]", socketChannel);
					...
					InetAddress inetLocalAddress = socket.getLocalAddress();
					...
					System.out.println("inetLocalAddress.getCanonicalHostName() = " + inetLocalAddress.getCanonicalHostName());
					System.out.println("inetLocalAddress.getHostAddress()       = " + inetLocalAddress.getHostAddress()      );
					System.out.println("inetLocalAddress.getHostName()          = " + inetLocalAddress.getHostName()         );
					...
					System.out.println("localAddress.getPort()     = " + localAddress.getPort());

					System.out.println("remoteAddress.getHostName() = " + remoteAddress.getHostName());
					System.out.println("remoteAddress.getPort()     = " + remoteAddress.getPort());
				}
			}
		}
	}
