package ic.vela.ibridge.server.ext.virtualext.resource.hashmap;
...
/*------------------------------------------------------------------*/
{
	 ...
	 */
	/*------------------------------------------------------------------*/
	public HashMap<String, HashMap<String,XmlObject>> getHashMap() throws Exception
	/*------------------------------------------------------------------*/
	{
		boolean flag = true;
		
		HashMap<String, HashMap<String,XmlObject>> banker = null;
