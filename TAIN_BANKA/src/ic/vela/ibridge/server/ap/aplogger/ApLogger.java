package ic.vela.ibridge.server.ap.aplogger;
 ...
 */
/*==================================================================*/
public class ApLogger extends Thread
/*------------------------------------------------------------------*/
{
	/*==================================================================*/
	/*
	 ...
	 */
	/*------------------------------------------------------------------*/
	public ApLogger() throws Exception
	{
		boolean flag = true;
		...
		if (flag) {
			...
			this.logQueue = this.apManager.getResourceBanker().getQueueBanker().getQueue().get("LOGGER_QUEUE");
			
			/*
			 * 로그 파일명을 얻는다.
			 */
			this.strFileYYYYMMDD = IBridgeParameter.getParam("ap.log.file");
		}
	}
