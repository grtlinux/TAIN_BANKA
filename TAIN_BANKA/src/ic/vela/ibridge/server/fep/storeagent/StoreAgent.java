package ic.vela.ibridge.server.fep.storeagent;
	...
	public StoreAgent()
	{
		...
		if (flag) {     // DATE.2013.06.22
			try {
				...
				this.readQueue  = this.fepManager.getResourceBanker().getQueueBanker().getQueue().get("SEND_STOREAGENT_QUEUE");
				
				// StoreAgent -> SendToExt
				this.writeQueue = this.fepManager.getResourceBanker().getQueueBanker().getQueue().get("SEND_SENDTOEXT_QUEUE");
