package ic.vela.ibridge.server.fep.feplogger;
 ...
 */
/*==================================================================*/
public class FepLogger extends Thread
/*------------------------------------------------------------------*/
{
	/*==================================================================*/
	/*
	 ...
	 */
	/*------------------------------------------------------------------*/
	public FepLogger() throws Exception
	{
		boolean flag = true;
		...
		if (flag) {
			...
			this.logQueue = this.fepManager.getResourceBanker().getQueueBanker().getQueue().get("LOGGER_QUEUE");
			
			/*
			 * 로그 파일명을 얻는다.
			 */
			this.strFileYYYYMMDD = IBridgeParameter.getParam("fep.log.file");
		}
	}
