...
set MAIN_CLASS=ic.vela.ibridge.test.selector.sessiontest.ServerSocketChannelSessionTestMain
...
set OPTION=%OPTION% -Dsystem.ib.param.basefolder=K:/WORK/fep/server/
set OPTION=%OPTION% -Dsystem.ib.param.waittime=1
set OPTION=%OPTION% -Dsystem.ib.param.loopcount=10
