...
set MAIN_CLASS=ic.vela.ibridge.util.Tailer
...
set OPTION=%OPTION% -Dsystem.ib.param.basefolder=%HOME_PATH%/server/fep/log/
set OPTION=%OPTION% -Dsystem.ib.param.filename=YYYYMMDD.log
